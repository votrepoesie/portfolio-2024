        ...
        if (window.location.pathname.includes('index.html')) {
            this.innerHTML = `
                <nav class="navbar">
                    ...
                    <ul class="nav-links">
                        <li class="nav-item draw"><a href="/subpage/draw.html">I draw,</a></li>
                        <li class="nav-item design"><a href="/subpage/design.html">design,</a></li>
                        <li class="nav-item code"><a href="/subpage/code.html">code,</a></li>
                        <li class="nav-item make"><a href="/subpage/make-things.html">and make things.</a></li>
                    </ul>
